    ...
    <div className='w-full min-h-screen flex items-center justify-center '>
      <div className='w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          <input type="text" required value={title} placeholder="Give mew a title"
          className='w-full h-full text-lg bg-transparent fotn-semibold outline-none border-none placeholder:text-gray-400 text-textColor'
