...
const Header = () => {
	...
	return (
		<header className="fixed w-screen  p-3 px-4 md:p-6 md:px-16 bg-primary z-50">
			{/* desktop and tablet */}
			<div className="hidden md:flex w-full h-full items-center justify-between">
				<Link to="/" className="flex items-center space-between gap-2">
					<img src={Logo} alt="logo" className="w-8 object-cover" />
					<p className="text-headingColor text-xl font-bold">City</p>
				</Link>
				{/* menu and cart and profile */}
				...
				<div className="relative">
					...
					{isMenu && (
						...
						>
							...
							<p className="p-2 m-2 flex items-center rounded-md shadow-md justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logOut}>
								Logout <MdLogout />
							</p>
						</motion.div>
					)}
